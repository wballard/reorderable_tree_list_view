...
void main() {
  group('TreeTheme', () {
    ...
    testWidgets('should use default theme when not provided', (
      WidgetTester tester,
    ) async {
      TreeTheme? capturedTheme;
    ...
    testWidgets('should merge with Material theme', (
      WidgetTester tester,
    ) async {
      TreeTheme? capturedTheme;
  ...
  group('TreeThemeData', () {
    testWidgets('should provide theme to descendants', (
      WidgetTester tester,
    ) async {
      const TreeTheme customTheme = TreeTheme(indentSize: 48);
      TreeTheme? capturedTheme;
    ...
    testWidgets('should update when theme changes', (
      WidgetTester tester,
    ) async {
      const TreeTheme theme1 = TreeTheme();
