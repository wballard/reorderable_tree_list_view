...
void main() {
  group('ReorderableTreeListView Expansion Integration', () {
    ...
    group('initialization', () {
      testWidgets('should expand all folders by default', (WidgetTester tester) async {
      ...
      testWidgets('should collapse all folders when expandedByDefault is false', (WidgetTester tester) async {
        await tester.pumpWidget(MaterialApp(
          home: Scaffold(
            body: ReorderableTreeListView(
              paths: testPaths,
      ...
      testWidgets('should respect initiallyExpanded parameter', (WidgetTester tester) async {
        await tester.pumpWidget(MaterialApp(
          home: Scaffold(
            body: ReorderableTreeListView(
              paths: testPaths,
    ...
    group('interaction', () {
      testWidgets('should toggle expansion when icon is tapped', (WidgetTester tester) async {
        await tester.pumpWidget(MaterialApp(
          home: Scaffold(
            body: ReorderableTreeListView(
              paths: testPaths,
      ...
      testWidgets('should expand collapsed folder when icon is tapped', (WidgetTester tester) async {
        await tester.pumpWidget(MaterialApp(
          home: Scaffold(
            body: ReorderableTreeListView(
              paths: testPaths,
    ...
    group('edge cases', () {
      testWidgets('should handle empty paths list', (WidgetTester tester) async {
        await tester.pumpWidget(MaterialApp(
          home: Scaffold(
            body: ReorderableTreeListView(
              paths: const [],
