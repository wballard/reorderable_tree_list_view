...
void main() {
  group('ReorderableTreeListViewItem', () {
    ...
    testWidgets('applies correct indentation based on depth', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('applies correct indentation for nested nodes', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('child is properly wrapped in Expanded', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('preserves node key', (WidgetTester tester) async {
      ...
      final ReorderableTreeListViewItem item = tester
          .widget<ReorderableTreeListViewItem>(itemFinder);
